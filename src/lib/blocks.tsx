...
export const BLOCKS = {
    ...
    BLOCK_VOID : new Block('Void', '/blocks/suspicious_sand_3.png', Infinity, 0),
    BLOCK_PATH : new Block('Path', '/blocks/lime_concrete.png', 0, 0),
    BLOCK_WATER : new Block('Water', '/blocks/water.png', 8, 8),
    BLOCK_CACTUS : new Block('Cactus', '/blocks/cactus.png', Infinity, 8),
    BLOCK_HONEY : new Block('Honey', '/blocks/honey.png', 6, 0),
    BLOCK_MAGMA : new Block('Magma', '/blocks/magma.png', Infinity, 16),
    BLOCK_MAGMA_ZOMBIE : new Block('Magma Zombie', '/blocks/magma.png', 16, 8),
    BLOCK_LAVA : new Block('Lava', '/blocks/lava.png', Infinity, 16),
